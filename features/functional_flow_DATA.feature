Feature: This feature file tests all the scenarios from functional_flow_DATA tab on Updated-fatfreecrm.xlsx

  Background:
    * I read the data from the "Updated-fatfreecrm.xlsx" and "functional_flow_DATA" tab
