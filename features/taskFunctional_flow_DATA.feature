Feature: This feature file tests all the scenarios from taskFunctional_flow_DATA tab on fatfreecrm.xlsx

  Background:
    * I read the data from the "fatfreecrm.xlsx" and "taskFunctional_flow_DATA" tab
