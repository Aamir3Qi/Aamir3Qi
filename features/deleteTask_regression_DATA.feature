Feature: This feature file tests all the scenarios from deleteTask_regression_DATA tab on Updated-fatfreecrm.xlsx

  Background:
    * I read the data from the "Updated-fatfreecrm.xlsx" and "deleteTask_regression_DATA" tab
